...
import com.study.springsecsection1.filter.JwtTokenGeneratorFilter;
import com.study.springsecsection1.filter.JwtTokenValidatorFilter;
...
public class ProjectSecurityProdConfig {
    ...
    SecurityFilterChain defaultSecurityFilterChain(HttpSecurity http) throws Exception {
        ...
        http.sessionManagement(sessionConfig -> sessionConfig.sessionCreationPolicy(SessionCreationPolicy.STATELESS))
                ...
                .authorizeHttpRequests(requests -> requests
                        ...
                        .requestMatchers("/notices", "/contact", "/register", "/error", "/invalidSession",
                                "/apiLogin").permitAll());
    ...
    public AuthenticationManager authenticationManager(UserDetailsService userDetailsService) {
        AuthenticationProvider authenticationProvider = new EasyBankProdUsernamePwdAuthenticationProvider(userDetailsService,
                passwordEncoder());
